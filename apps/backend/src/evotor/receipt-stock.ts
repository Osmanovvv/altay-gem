 ...
 *
 * Порядок применения абсолютов охраняет stock_asof в БД (см. evotor.service):
 * абсолют пишется, только если он не старее уже применённого. Дельта без
 * времени документа коммутативна и порядка не требует.
 */
