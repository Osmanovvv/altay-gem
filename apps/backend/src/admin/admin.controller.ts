...
export class AdminController {
  ...
  /**
   * Ручной прогон сверки ПРЯМО ИЗ ОБЛАКА Эвотора — без файла выгрузки.
   * Нужен для проверки, что права на номенклатуру и остатки доехали до
   * токена установки: до этого эндпоинт вернёт пустой список и алерт с
   * причиной (403 — прав нет, 402 — приложение не на всех кассах).
   */
  @Post('evotor/cloud-sync')
  @HttpCode(200)
  @UseGuards(AdminGuard)
  runCloudSync() {
    return this.reconcile.runCloudSync();
  }
