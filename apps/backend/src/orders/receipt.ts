...
export interface ReceiptConfig {
  /**
   * Ставка НДС (ФФД/ЮKassa): 1 Без НДС, 2 — 0%, 3 — 10%, 4 — 20%, 5 — 10/110,
   * 6 — 20/120, 7 — 5%, 8 — 7%, 9 — 5/105, 10 — 7/107, 11 — 22%, 12 — 22/122.
   * Коды 7–12 добавлены с налоговой реформой: льготные ставки УСН (5/7%) и
   * рост базовой ставки до 22% с 01.01.2026.
   *
   * У заказчицы в Эвоторе проставлено НДС 5% (3576 товаров из 3596, проверено
   * по облаку 10.08.2026) — то есть УСН с доходом выше порога и льготной
   * ставкой. Поэтому на проде YOOKASSA_VAT_CODE=7: онлайн-чек обязан совпадать
   * с чеком кассы по тому же товару.
   */
  vatCode: number;
